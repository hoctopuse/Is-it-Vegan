...
internal enum class QualifierAttachmentForm { PARENTHETICAL, DIRECT_SUFFIX }
internal enum class ParenthesisPolicy { IGNORE_CONTENT_FOR_VERDICT }
...
internal data class OriginQualifierExtraction(
    val text: String,
    val qualification: OriginQualification? = null
)

internal data class ProtectedExpressionMatch(
    val id: String,
...
internal data class OriginRulesLoadResult(
 ...
 */
internal class OriginQualifierRuleSet private constructor(
