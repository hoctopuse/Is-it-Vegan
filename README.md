...
La version documentée est **0.6.4.1** (`versionCode 29`). L’interface est disponible en français, anglais et néerlandais. Le moteur distingue la compatibilité vegan, la classification végétarienne détaillée, les ingrédients incertains, les éléments inconnus et les traces de contamination croisée.
